...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      productsICanEat = _(products).filter(function(product) {
          var containsMuchsroom = function (ingredients) {
              var isMushroom = function(ingredient) {
                  return ingredient === "mushrooms";
              }
              return _(ingredients).any(isMushroom)
          }
          return !containsMuchsroom(product.ingredients) && !product.containsNuts
      })
      expect(productsICanEat.length).toBe(1);
  });
